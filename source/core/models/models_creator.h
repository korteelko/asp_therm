...
class ModelsCreator {
 public:
  static modelGeneral* GetCalculatingModel(
      model_str ms,
 ...
 private:
  static modelGeneral* set_model(const model_input& mi, double p, double t);
  // set gas_mix from xml files
  static model_input set_input(model_str ms,
                               binodalpoints* bp,
                               double p,
                               double t,
  ...
  static modelGeneral* initModel(model_str ms,
                                 binodalpoints* bp,
                                 double p,
                                 double t,
                                 const_dyn_union cdu);
