...
typedef std::function<merror_t(db_parameters*, const std::string& value)>
    update_dbconfig_f;
...
merror_t set_db_parameter(db_parameters* dst,
...
static std::map<const std::string, rg_model_id> map_model_tpls =
    std::map<const std::string, rg_model_id>{
        {STRTPL_MODEL_IDEAL_GAS,
         rg_model_id(rg_model_t::IDEAL_GAS, MODEL_SUBTYPE_DEFAULT)},
        {STRTPL_MODEL_REDLICH_KWONG,
         rg_model_id(rg_model_t::REDLICH_KWONG, MODEL_SUBTYPE_DEFAULT)},
        {STRTPL_MODEL_REDLICH_KWONG_SOAVE,
         rg_model_id(rg_model_t::REDLICH_KWONG, MODEL_RK_SUBTYPE_SOAVE)},
        {STRTPL_MODEL_PENG_ROBINSON,
         rg_model_id(rg_model_t::PENG_ROBINSON, MODEL_SUBTYPE_DEFAULT)},
        {STRTPL_MODEL_PENG_ROBINSON_B,
